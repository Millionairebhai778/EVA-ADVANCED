...
class script(object):
    START_TXT = environ.get("""<b>Hello {},
ഇത് മൂവി ക്ലബ്ബിനു വേണ്ടി കഷ്ടപ്പെടുന്ന ഒരു പാവം ബോട്ടാണ്. ഇനി നിങ്ങൾക്ക് സിനിമകൾ കിട്ടണം എങ്കിൽ ഇവിടെ കുത്തി ഇരിക്കാതെ ഞങ്ങളുടെ ഗ്രൂപ്പിൽ കയറുക കൂടാതെ പുതിയ സിനിമ റിലീസിന് വേണ്ടി താഴെയുള്ള ചാനൽ സബ്സ്ക്രൈബ് കൂടി ചെയ്യുക</b>"""
    HELP_TXT = """𝙷𝙴𝚈 {}
